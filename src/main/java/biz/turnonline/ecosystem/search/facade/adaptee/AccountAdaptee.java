...
public class AccountAdaptee
        ...
        implements GetExecutorAdaptee<Account>, ListExecutorAdaptee<Account>, DeleteExecutorAdaptee<Account>
{
    @Inject
    public AccountAdaptee( Provider<SearchEngine> client )
    {
        super( client );
    }
    ...
    {
        SearchEngine.Accounts.List list = ( SearchEngine.Accounts.List ) request;
